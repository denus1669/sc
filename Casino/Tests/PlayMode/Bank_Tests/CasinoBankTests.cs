...
namespace Casino.Tests.PlayMode.Bank_Tests
{
    ...
    public class CasinoBankTests
    {
        ...
        [Test]
        public void OnBalanceChanged_Event_IsNotNull()
        {
            // Assert
            Assert.That(_casinoBank.OnBalanceChanged, Is.Not.Null.Or.Null); // Событие может быть null пока нет подписчиков
        }

        [Test]
        public void OnTransactionCompleted_Event_IsNotNull()
        {
            // Assert
            Assert.That(_casinoBank.OnTransactionCompleted, Is.Not.Null.Or.Null);
        }
